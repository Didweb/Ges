...
use Gestor\FeinaBundle\Entity\Categoria;
use Gestor\FeinaBundle\Form\CategoriaType;
...
class CategoriaController extends Controller
{
    ...
    public function indexAction()
    {
		...
		$dql = "SELECT c FROM GestorFeinaBundle:Categoria c";
     ...
     * @Method("POST")
     * @Template("GestorFeinaBundle:Categoria:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GestorFeinaBundle:Categoria')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("GestorFeinaBundle:Categoria:edit.html.twig")
     */
