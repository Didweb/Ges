...
use Gestor\FeinaBundle\Entity\Fabricante;
use Gestor\FeinaBundle\Form\FabricanteType;
...
class FabricanteController extends Controller
{
    ...
    public function indexAction()
    {
		...
		$dql = "SELECT f FROM GestorFeinaBundle:Fabricante f";
     ...
     * @Method("POST")
     * @Template("GestorFeinaBundle:Fabricante:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GestorFeinaBundle:Fabricante')->find($id);
    ...
    public function editAction(Request $request,$id,$locale='')
    {
		...
		$query = $em->getRepository('GestorFeinaBundle:Faena')
					->findByTieneFabricante($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("GestorFeinaBundle:Fabricante:edit.html.twig")
     */
