...
use Gestor\FeinaBundle\Entity\Imagen;
use Gestor\FeinaBundle\Form\ImagenType;
use Gestor\FeinaBundle\Form\ImagenShowType;
...
class ImagenController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GestorFeinaBundle:Imagen')->findAll();
     ...
     * @Method("POST")
     * @Template("GestorFeinaBundle:Imagen:new.html.twig")
     */
    ...
    */
    ...
    public function newAction($idfaena)
    {
        ...
        $entity = new Imagen();
        $idfa= $em->getReference('GestorFeinaBundle:Faena', $idfaena);
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('GestorFeinaBundle:Imagen')->findByFaena($idfaena,array('orden' => 'ASC'));
    ...
    public function editAction($id)
    {
        ...
        $entity = $em->getRepository('GestorFeinaBundle:Imagen')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("GestorFeinaBundle:Imagen:edit.html.twig")
     */
